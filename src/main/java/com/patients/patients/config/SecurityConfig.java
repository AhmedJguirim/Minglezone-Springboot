package com.patients.patients.config;

import com.patients.patients.services.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .and().authorizeHttpRequests().requestMatchers("/users/**").authenticated()
                .and().authorizeHttpRequests().requestMatchers("/posts").authenticated()
                .and().authorizeHttpRequests().requestMatchers("/posts/**").authenticated()
                .and().authorizeHttpRequests().requestMatchers("/tags").authenticated()
                .and().authorizeHttpRequests().requestMatchers("/tags/**").authenticated()
                .and()
                .authorizeHttpRequests().requestMatchers("/swagger-ui.html").permitAll()
                .and().authorizeHttpRequests().requestMatchers("/swagger-ui/index.html").permitAll()
